...
def set_var (variation_dict):
    # get file content from baseline params and exctract param section
    ...
    for variation_per_channel in variation_dict:
        ...
        # create the list of new params in the correct format
    ...
    if os.path.isdir('x86_64'):  # compiled mod files exist, delete them
        shutil.rmtree('x86_64')

    #print os.path.isdir('mod_files')
    #sp.call(["nrnivmodl mod_files/"], shell=True)
